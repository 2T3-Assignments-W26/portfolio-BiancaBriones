...
|Copy items             |Copy-Item <Source> <Destination>   |cp,cp1         |
...
_"PowerShell is great because we had a series of rockstar engineers add their awesomeness to the project."_

_Source: ( from the interview with Jeffrey Snover, PowerShell Inventor)_ 
